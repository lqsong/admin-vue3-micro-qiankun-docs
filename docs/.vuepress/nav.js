module.exports = [
    ...
    },
    {
        text: '预览',
        items: [
            {text: 'main', link: 'http://main-demo.admin-vue3-micro-qiankun.liqingsong.cc/'},
            {text: 'main-antd', link: 'http://main-antd-demo.admin-vue3-micro-qiankun.liqingsong.cc'},
        ]
    },
    {
        text: 'GitHub',
		items: [
            {text: 'Github', link: 'https://github.com/lqsong/admin-vue3-micro-qiankun'},
            {text: 'Gitee', link: 'https://gitee.com/lqsong/admin-vue3-micro-qiankun'},
        ]
    }
]